...
- (void)setStatus:(Status *)status
{
    ...
    CGSize timeSize = [status.createdAt sizeWithFont:kTimeFrameFont];
    ...
    if (status.picUrls.count) { // 6.有配图
        ...
        CGSize imageSize = [UIPictureCell UIPictureCellSizeWithCount:status.picUrls.count];
        ...
        if (status.retweetedStatus.picUrls.count) {
            ...
            CGSize imageSize = [UIPictureCell UIPictureCellSizeWithCount:status.retweetedStatus.picUrls.count];
